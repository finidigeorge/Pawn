...
PawnStats =
{
	...
	{"Block", "Block", "Chance to block an attack."},
...
PawnRegexes =
{
	...
	{"^Equip: Increases your chance to block an attack with a shield by (%d+)%%%.?$", "Block"},
	{"^Equip: Improves your chance to block an attack with a shield by (%d+)%%%.?$", "Block"},
	{"^Equip: Increases your chance to block attacks with a shield by (%d+)%%%.?$", "Block"},
	{"^Equip: Improves your chance to block attacks with a shield by (%d+)%%%.?$", "Block"},
	{"^%+?(%d+) Block$", "BlockValue"},
	...
	{"^%+(%d+) Defense$", "Defense"},
	{"^Equip: Increased Defense %+(%d+)%.?$", "Defense"},
	{"^Equip: Increased Defense (%d+)%.?$", "Defense"},
	{"^Equip: Increases defense rating by (%d+)%.?$", "Defense"},
	{"^Equip: Increases your defense rating by (%d+)%.?$", "Defense"},
	{"^Equip: Improves your defense rating by (%d+)%.?$", "Defense"},
	{"^Equip: Improvements your defense rating by (%d+)%.?$", "Defense"},
