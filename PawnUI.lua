...
function PawnUI_InventoryPawnButton_Move()
	...
	if PawnOptions.ButtonPosition == PawnButtonPositionRight or PawnOptions.ButtonPosition == nil then
		PawnUI_InventoryPawnButton:ClearAllPoints()
		PawnUI_InventoryPawnButton:SetPoint("BOTTOMRIGHT", "CharacterFrame", "BOTTOMRIGHT", -33, 76)
		PawnUI_InventoryPawnButton:SetFrameLevel(CharacterFrame:GetFrameLevel() + 5)
		PawnUI_InventoryPawnButton:Show()
		if PawnUI_InspectPawnButton then
			PawnUI_InspectPawnButton:ClearAllPoints()
			PawnUI_InspectPawnButton:SetPoint("BOTTOMRIGHT", "InspectFrame", "BOTTOMRIGHT", -33, 76)
			PawnUI_InspectPawnButton:SetFrameLevel(InspectFrame:GetFrameLevel() + 5)
			PawnUI_InspectPawnButton:Show()
		end
	elseif PawnOptions.ButtonPosition == PawnButtonPositionLeft then
		PawnUI_InventoryPawnButton:ClearAllPoints()
		PawnUI_InventoryPawnButton:SetPoint("BOTTOMLEFT", "CharacterFrame", "BOTTOMLEFT", 18, 14)
		PawnUI_InventoryPawnButton:Show()
		if PawnUI_InspectPawnButton then
			PawnUI_InspectPawnButton:ClearAllPoints()
			PawnUI_InspectPawnButton:SetPoint("BOTTOMLEFT", "InspectFrame", "BOTTOMLEFT", 18, 14)
			PawnUI_InspectPawnButton:Show()
		end
	else
...
function PawnUI_InventoryPawnButton_OnEnter(this)
	...
	GameTooltip:AddLine("Pawn", 1, 1, 1)
	GameTooltip:AddLine(PawnUI_InventoryPawnButton_Tooltip, 1, 1, 1)
...
function PawnUI_InspectPawnButton_Attach()
	VgerCore.Assert(InspectFrame ~= nil, "InspectFrame should be loaded by now!")
	CreateFrame("Button", "PawnUI_InspectPawnButton", InspectFrame, "PawnUI_InspectPawnButtonTemplate")
	PawnUI_InspectPawnButton:SetParent(InspectFrame)
...
function PawnUIFrame_CurrentScaleDropDown_ItemClicked()
	PawnUIGetStringCancel()
	PawnUIFrame_CurrentScaleDropDown_SelectScale(this:GetText())
end
...
function PawnUIFrame_StatsList_Update()
	...
	FauxScrollFrame_Update(PawnUIFrame_StatsList, table.getn(PawnStats), PawnUIStatsListHeight, PawnUIStatsListItemHeight) -- list, number of items, number of items visible per page, item height
...
function PawnUIFrame_StatsList_UpdateStatItem(i, Index, ThisScale)
	...
	if Index <= table.getn(PawnStats) then
...
function PawnUIFrame_StatsList_SelectStat(Index)
	...
	if not Index or Index < 0 or Index > table.getn(PawnStats) then
		Index = 0
	end
...
function PawnUI_CompareItems()
	...
	local StatCount = table.getn(PawnStats)
...
function PawnUISwitchToTab(TabNumber)
	local TabCount = table.getn(PawnUITabList)
...
function PawnUIFrame_TooltipOn(this)
