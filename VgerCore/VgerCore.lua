...
function VgerCore.Message(Text)
	...
	if type(Text) == "table" then Text = "table" end
	if DEFAULT_CHAT_FRAME then
		DEFAULT_CHAT_FRAME:AddMessage(VgerCore.Color.Orange .. tostring(Text))
	else
		UIErrorsFrame:AddMessage(tostring(Text), 1.0, 0.5, 0.0)
	end
end
...
function VgerCore.HookInsecureFunction(arg1, arg2, arg3)
	...
	elseif TypeOfObject == "string" then -- FunctionName, Hook
		...
		if OldFunction then
			setglobal(arg1, VgerCore.CreateHookFunction(OldFunction, arg2))
		else
...
function VgerCore.CreateHookFunction(OldFunction, Hook)
	return function(a1, a2, a3, a4, a5, a6, a7, a8, a9, a10)
		local r1, r2, r3, r4, r5, r6, r7, r8, r9, r10 = OldFunction(a1, a2, a3, a4, a5, a6, a7, a8, a9, a10)
